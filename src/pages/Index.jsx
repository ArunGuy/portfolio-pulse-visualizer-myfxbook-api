...
const HistoryCarousel = () => {
  ...
  const historyItems = [
    ...
    {
      title: "เนื้อหาเพิ่มเติม 1",
      content: "นี่คือพื้นที่สำหรับเนื้อหาเพิ่มเติมที่คุณสามารถเพิ่มข้อมูลเกี่ยวกับประวัติหรือการพัฒนาของกลุ่ม Mhagutsfund ได้"
    },
    {
      title: "เนื้อหาเพิ่มเติม 2",
      content: "คุณสามารถใส่ข้อมูลเพิ่มเติมเกี่ยวกับเป้าหมายในอนาคต, ความสำเร็จที่ผ่านมา, หรือข้อมูลอื่นๆ ที่น่าสนใจเกี่ยวกับกลุ่ม Mhagutsfund ในส่วนนี้"
    }
  ];
